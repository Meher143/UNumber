...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		if (check("\n******************\n" + 
				...
				"*\n" + 
				"******************\n" + 
				"operand1 = 0.0E0 0.00000000000000000000E0\n" + 
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = false\n" + 
				"operand2 = 0.0E0 0.00000000000000000000E0\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = false\n" + 
				"result = 0.0E0 0.00000000000000000000E0\n" +
				"     resultErrorMessage = \n" + 
				"*******************\n\n", test.debugToString())) {
			numPassed++;
		...
		if (check("\nReturned boolean = true\n******************\n" + 
				...
				"*\n" + 
				"******************\n" + 
				"operand1 = 1.2345678901234560E15 0.00000000000000000000E0\n" + 
		...
		if (check("\nReturned boolean = true\n******************\n" + 
				...
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = false\n" + 
				"operand2 = 1.2345601234567890E15 0.00000000000000000000E0\n" + 
		...
		if (check("\nReturned boolean = true\n******************\n" + 
				...
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = false\n" + 
				"result = 1.2345601234567890E15 0.00000000000000000000E0\n" +
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 9.99999990E7 0.00000000000000000000E0\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				"operand1 = 1.23456780E7 0.00000000000000000000E0\n" + 
				"     operand1ErrorMessage = __0\n" + 
				"     operand1Defined = true\n" + 
				"operand2 = 8.76543210E7 0.00000000000000000000E0\n" + 
				"     operand2ErrorMessage = __0\n" + 
				"     operand2Defined = true\n" + 
				"result = 9.99999990E7 0.00000000000000000000E0\n" +
				"     resultErrorMessage = __0\n" + 
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = -7.53086430E7 0.00000000000000000000E0\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				...
				"     operand2ErrorMessage = __0\n" + 
				"     operand2Defined = true\n" + 
				"result = -7.53086430E7 0.00000000000000000000E0\n" +
				"     resultErrorMessage = __0\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 1.0821520223746380E15 0.00000000000000000000E0\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				...
				"     operand2ErrorMessage = __0\n" + 
				"     operand2Defined = true\n" + 
				"result = 1.0821520223746380E15 0.00000000000000000000E0\n" +
				"     resultErrorMessage = __0\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 0.14084505885340210439 0.000000000000000000000000000000000000E0\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				...
				"     operand2ErrorMessage = __0\n" + 
				"     operand2Defined = true\n" + 
				"result = 0.14084505885340210439 0.000000000000000000000000000000000000E0\n" +
				"     resultErrorMessage = __0\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 8 0.00000000000000000000E0\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				"operand1 = 64 0.00000000000000000000E0\n" + 
				"     operand1ErrorMessage = __0\n" + 
				"     operand1Defined = true\n" + 
				"operand2 = 0.0E0 0.00000000000000000000E0\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = false\n" + 
				"result = 8 0.00000000000000000000E0\n" +
				"     resultErrorMessage = __0\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
