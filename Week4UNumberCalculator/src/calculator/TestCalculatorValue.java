...
public class TestCalculatorValue {
	...
	public static void main(String[] args) {
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.1234567890123456E+16\nerrorMessage = \n", test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.12345678901234560000E+16\nerrorMessage = \n", test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.30000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = -0.10000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.20000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.50000000000000000000E+0\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.50000000000000000000E+1\nerrorMessage = Division not possible by zero\n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.52000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.00000000000000000000E+1\nerrorMessage = Division not possible by zero\n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		System.out.println();
		//12. Exceeding value than long Input
		left = new CalculatorValue("1234564687641657354654134643135431543135433413543123541234354");														// Set up the test

		System.out.println("12. Exceeding value longer than Input: \n1\n2");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.1234564687641657354654134643135431543135433413543123541234354E+61\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 13. Perform Addition using Double Integers.

		left = new CalculatorValue("5.2");										// Set up the test
		right = new CalculatorValue("0.4");
		left.add(right);                              							// Perform the test

		System.out.println("13. Addition: \n5.2\n0.4");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.56000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 14. Perform Subtraction using Double Integers.
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.48000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.21666666666666666667E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 17. Perform Square root test

		left = new CalculatorValue("4.0");										// Set up the test

		left.sqrt();                              							// Perform the test

		System.out.println("17. Square Root: \n4.0");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.2000000000000000000000000000000000000000E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 18. Perform Square root test

		left = new CalculatorValue("13.0");										// Set up the test

		left.sqrt();                              							// Perform the test

		System.out.println("18. Square Root: \n13.0");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.3605551275463989293119221267470495946252E+1\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 19. Perform Square root test

		left = new CalculatorValue("123.45");										// Set up the test
		left.errorTerm = new UNumber("0.05");

		left.sqrt();                              							// Perform the test

		System.out.println("19. Square Root: \n123.45±0.05");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.1111080555135405112450044387430752414899E+2errorTerm = +0.26E-1\nerrorMessage = \n", left.debugToStringET())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 20. Perform Square root test

		left = new CalculatorValue("-44");										// Set up the test

		left.sqrt();                              							// Perform the test

		System.out.println("20. Square Root: \n-44");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = -0.44E+2\nerrorMessage = SquareRoot not possible for negative numbers\n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		// 21. Step 6 of Hohmann Transfer Sheet - Calculate the period of the
		//		transfer orbit

		CalculatorValue piSq = new CalculatorValue("3.14159265358979");

		piSq.mpy(piSq);

		System.out.println("Here is piSq: " + piSq.toString());

		CalculatorValue aCube = new CalculatorValue("188760000");

		aCube.mpy(aCube);
		aCube.mpy(new CalculatorValue("188760000"));

		System.out.println("Here is aCube: " + aCube.toString());

		left = new CalculatorValue("4");										// Set up the test

		left.mpy(piSq);
		left.mpy(aCube);
		System.out.println("Here is num: " + left.toString());
		// Perform the test
		right = new CalculatorValue("132700000000");

		left.div(right);
		left.sqrt();


		System.out.println("21. Transfer Orbit Period: \n44731077.5180507");

		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("measuredValue = +0.4473107751805002070064371635923965080856E+8\nerrorMessage = \n", left.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
