...
public class MeasuredValueRecognizer {
	...
	public static String checkMeasureValue(String input) {
		//System.out.println(input + "Reached MVR");
		...
		while (running) {
			...
			case 5: 
				...
				// If the current character is in the range from 1 to 9, it transitions to state 7
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
				}
		...
		case 0:
			...
			measuredValueIndexofError = currentCharNdx;		// Copy the index of the current character;
			measuredValueErrorMessage = "The first character must be a digit or a \n decimal point.";
		...
		case 1:
			...
			if (currentCharNdx<input.length()) {
				...
				// forward.
				measuredValueErrorMessage = "This character may only be an \"E\", an \"e\", a \n digit, "
		...
		case 4:
			...
			if (currentCharNdx<input.length()) {
				measuredValueErrorMessage = "This character may only be an \"E\", an \"e\", or \n it must"
		...
		case 5:
			...
			measuredValueErrorMessage = "This character may only be a digit, a plus \n , or minus "
					+ "character.\n";
			return measuredValueErrorMessage + displayInput(input, currentCharNdx);
		default:
			return "";
